      ...
      >
        <Link href="/giving">
          <div className="flex flex-col items-center justify-between cursor-pointer">
            ...
            <p className="text-white text-xs md:text-sm">Give now</p>
          </div>
        </Link>
        <Link href="https://www.youtube.com/@omegachapel?sub_confirmation=1">
          <div className="flex flex-col items-center justify-between cursor-pointer">
            ...
            <p className="text-white text-xs md:text-sm">Subscribe</p>
          </div>
        </Link>
        ...
        <div className="flex flex-col items-center justify-between">
          ...
          <p className="text-white text-xs md:text-sm">Follow us</p>
        </div>
        <Link href="https://www.youtube.com/@omegachapel/videos">
          <div className="md:flex md:flex-col md:items-center justify-between hidden cursor-pointer">
            <div>
              <BsPlay color="white" size={20} />
            </div>
            <p className="text-white text-xs md:text-sm">Watch now</p>
          </div>
        </Link>
      </div>
    </div>
